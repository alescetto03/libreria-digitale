...
public class AppController {
    ...
    public void registerUser(String username, String email, String password, String confirmPassword, String name, String surname, java.util.Date birthdate) throws Exception {
